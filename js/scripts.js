$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Tina's und Anton's Hochzeit",

            // Event start date
            start: new Date('May 22, 2026 10:00'),
            ...
            // Event Description
            description: "Wir können es nicht erwarten euch zu empfangen. Bei Fragen oder Problemen, wendet euch bitte an hochzeit@wltr.be"
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== '496f8b3554f398de3ea96f21484dd5a3') {
            ...
            $.post('https://script.google.com/macros/s/AKfycbyWN5jZpxcw_F-itSffMZAnysgBrB-uwXAhbobCVEa0mDnpzhBT7s85hIz6lTMrDctK/exec', data)
                .done(function (data) {
                    console.log(data);
